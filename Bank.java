...
// Generate a new universally unique ID for an accounts
// @return the uuid
...
// add an account
//@param anAcct       the acount to add
...
public User addUser(String firstName, String lastName, String pin) {
  ...
  // create a new user object and add it to our lists
...
//@param pins         the pin of the user
...
//                    if it is not.
  public User userLogin(String UserId, String pin) {
    ...
    //if unable to find user ID or valid pin
    return null;
  }
